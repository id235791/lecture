				...
				<tr>
					<td>
						<c:if test="${board.userid == loginUser}">
							<a class="btn" href="${cp}/boardupdate.bo?boardnum=${board.boardnum}&page=${param.page}&keyword=${param.keyword}">수정</a>
							<a class="btn" href="${cp}/boarddelete.bo?boardnum=${board.boardnum}&page=${param.page}&keyword=${param.keyword}">삭제</a>
						</c:if>
