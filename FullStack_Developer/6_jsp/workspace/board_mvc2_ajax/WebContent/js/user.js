...
function sendit(){
    ...
    const addretc = joinForm.addretc;
    ...
    xhr.open("POST",cp+"/api/user/join");
...
function checkId(){
	...
	xhr.open("GET",cp+"/api/user/checkid?userid="+userid.value);
	xhr.send();
}
