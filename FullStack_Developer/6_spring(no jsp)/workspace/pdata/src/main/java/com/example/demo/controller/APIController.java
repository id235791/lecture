...
public class APIController {
	final static String serviceKey = "z2fCg6mipty5dhNIILz85J1rXvn2AE8PKxlEVUi%2BVhOfdLBIyoY5lO0CUyfbKSOJ1rR66SiP0CBTXNdFlX5lfQ%3D%3D";
	@GetMapping("home")
	public void replace() {
	}
	
	//produces : 응답하는 데이터의 형태를 설정, json 형태로 응답해주면 클라이언트 쪽에서 JSON.parse()를 안 해도 된다. 
